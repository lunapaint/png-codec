...
describe('pngParser.integration Image Test Suite', () => {
  ...
  describe('Image is damaged beyond recognition', () => {
    createTests([
  ...
  describe('350x490, 24-bit RGB, non-interlaced, -2.5%', () => {
    createTests([
  ...
  describe('invalid number of hIST entries', () => {
    createTests([
  ...
  describe('multiple bKGD not allowed', () => {
    createTests([
  ...
  describe('Image is damaged beyond recognition, an outline of a face is visible', () => {
    createTests([
  ...
  describe('sCAL must precede IDAT', () => {
    createTests([
  ...
  describe('multiple sCAL not allowed', () => {
    createTests([
      ['1bcc34d49e56a2fba38490db206328b8', 'multiple sCAL not allowed', true], // TODO: Support sCAL?
    ], imageTestSuiteRoot);
  });
  describe('110x110, 24-bit RGB, non-interlaced, -54.6%', () => {
    createTests([
  ...
  describe('iCCP not allowed with sRGB', () => {
    createTests([
      ['2a6ff5f8106894b22dad3ce99673481a', 'iCCP not allowed with sRGB', true], // TODO: Support iCCP
    ], imageTestSuiteRoot);
  });
  describe('162x159, 32-bit RGB+alpha, non-interlaced, 75.2%', () => {
    createTests([
  ...
  describe('sBIT must precede IDAT', () => {
    createTests([
  ...
  describe('160x278, 16-bit grayscale+alpha, interlaced, 71.4%', () => {
    createTests([
  ...
  describe('invalid number of PLTE entries (257)', () => {
    createTests([
