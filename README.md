...
- **Correctness**: The library passes over 3000 tests including full coverage of [PngSuite](https://github.com/lunapaint/pngsuite), the "official" test suite for PNG.
