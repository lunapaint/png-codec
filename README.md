...
- **Correctness**: The library is tested with over 500 tests from [PngSuite](https://github.com/lunapaint/pngsuite) (100%), [imagetestsuite](https://github.com/lunapaint/imagetestsuite) (100% for supported chunks).
